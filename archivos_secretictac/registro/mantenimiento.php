...
<input type='text' maxlength='40' autocomplete="off" style='width:300px;' name='nombre_castellano'  value='<?php echo $nombre_castellano;?>'/>
</div>
...
<div id="campo_input"  align="left">
<input type='text' maxlength='40' autocomplete="off" style='width:300px;' name='nombre_valenciano'  value='<?php echo $nombre_valenciano;?>'/>
</div>
